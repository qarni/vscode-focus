...
export function getConfigValue(key: ConfigurationKeys, vscodeConfig: WorkspaceConfiguration, themeConfig: any = {}): any {
    return getConfigValueCore(key, vscodeConfig, themeConfig);
}

function getConfigValueCore(key: ConfigurationKeys, vscodeConfig: WorkspaceConfiguration, themeConfig: any = {}): any {
